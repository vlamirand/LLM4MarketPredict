...
- [x] Изучение доступных моделей трансформеров
- [x] Подготовка данных с криптовалютных бирж
- [x] Тестирование моделей на подготовленных данных
- [x] Анализ результатов тестирования

### Этап 2: Разработка и эксперименты с собственными моделями
- [x] Исследование научиных статей
